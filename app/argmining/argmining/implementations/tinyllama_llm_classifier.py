    ...
    def classify_stance(self, linked_argument_units: LinkedArgumentUnits, originalText: str) -> LinkedArgumentUnitsWithStance:
        ...
        for relation in linked_argument_units.claims_premises_relationships:
            ...
            for pid in relation.premise_ids:
                ...
                # Create context-aware prompt for stance classification
                prompt = f"""
You are an argument-mining stance classifier analyzing the relationship between a claim and premise.

Full Text Context: "{originalText}"

Claim: "{claim.text}"
Premise: "{premise.text}"

Task: Determine if the premise supports (pro) or opposes (con) the claim.

Definitions:
- pro: the premise provides evidence, reasons, or arguments that support the claim
- con: the premise provides evidence, reasons, or arguments that oppose or contradict the claim

Rules:
- Consider the logical relationship between the claim and premise
- Consider the broader context of the argument
- Output EXACTLY ONE lowercase word: "pro" or "con"
- Do NOT add punctuation or extra text
...
"""
                ...
                result_linked_arguments.append(
                    StanceRelation(
                        ...
                        stance=relationship,
                        confidence=None  # TinyLlama doesn't provide confidence scores
                    )
                )
