...
from app.argmining.argmining.models.argument_units import ArgumentUnit, LinkedArgumentUnits, LinkedArgumentUnitsWithStance, StanceRelation, ClaimPremiseRelationship, UnlinkedArgumentUnits
from typing import List
from app.argmining.argmining.config import OPENAI_KEY
...
def test_model():
    ...
    log.info(f"--- Running Step 1: Classify ADUs using OpenAI ---")
    ...
    log.info(f"--- Running Step 3: Classify Stance using OpenAI ---")
